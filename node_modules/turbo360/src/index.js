...
var Microservice = function(credentials){
	...
	var stripeMgr = StripeUtils(config)
	...
	var client = {
		...
		createStripeCharge: stripeMgr.createStripeCharge, // called from backend
		createStripeAccount: stripeMgr.createStripeAccount,
		recurringCharge: stripeMgr.recurringCharge,
		initializeStripe: stripeMgr.initializeStripe,
		submitStripeCharge: stripeMgr.submitStripeCharge, // called from client side
